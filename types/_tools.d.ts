type _StringKeys<T, X = never> = keyof T extends infer K ? K extends keyof T ? T[K] extends X ? never : K : never : never;
...
declare function getString<O, P extends string>(obj: O, path: AutoPath<O, P, string>): GetPath<O, P>;